      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.pad}>
          ...
          <View style={styles.ringSection}>
            ...
            {activeFasting && (
              <View style={[styles.stageBadge, { borderColor: `${currentStage.color}50`, backgroundColor: `${currentStage.color}12` }]}>
                  ...
                  <View key={stage.hours} style={styles.timelineItem}>
                    <View style={styles.timelineLeft}>
                      <View style={[
                        ...
                        isCurrent && { shadowColor: stage.color, shadowOpacity: 0.8, shadowRadius: 6, elevation: 4 },
                      ]} />
...
const styles = StyleSheet.create({
  ...
  goalBtnActive: { backgroundColor: colors.orangeDim, borderColor: `${colors.orange}40` },
  ...
  historyDone: { borderColor: `${colors.green}25` },
