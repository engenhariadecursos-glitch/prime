        ...
        <View style={styles.pad}>
          ...
          <View style={styles.macroCard}>
            <View style={styles.macroRings}>
              <RingProgress size={90} strokeWidth={8} progress={calPct} gradient
                value={`${totalCal}`} unit="kcal" label="Calorias" sublabel={`/${store.calorieGoal}`} />
              <RingProgress size={90} strokeWidth={8} progress={proteinPct} color={colors.blue}
                value={`${totalProtein}g`} unit="" label="Proteína" sublabel={`/${store.proteinGoal}g`} />
              <RingProgress size={90} strokeWidth={8} progress={waterPct} color={colors.green}
...
const styles = StyleSheet.create({
  ...
  waterVal: { fontSize: 13, color: colors.blue, fontWeight: '600' },
  waterBar: { height: 6, backgroundColor: colors.surface3, borderRadius: 3, overflow: 'hidden' },
  waterFill: { height: '100%', backgroundColor: colors.blue, borderRadius: 3 },
  waterBtns: { flexDirection: 'row', gap: 8 },
  waterBtn: {
    flex: 1, backgroundColor: 'rgba(64,196,255,0.1)', borderRadius: 10, padding: 10,
    alignItems: 'center', borderWidth: 1, borderColor: 'rgba(64,196,255,0.2)',
  },
  waterBtnTxt: { fontSize: 12, fontWeight: '700', color: colors.blue },
  ...
  mealCheat: { borderColor: colors.red, backgroundColor: colors.redDim },
  ...
  cheatToggleActive: { backgroundColor: colors.redDim, borderColor: colors.red },
