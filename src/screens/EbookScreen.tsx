                  ...
                  <View style={styles.booksList}>
                    {cat.books.map((book, i) => (
                      <TouchableOpacity
                        ...
                        activeOpacity={0.7}
                      >
                        <View style={[styles.bookCover, { backgroundColor: `${cat.color}20`, borderColor: `${cat.color}40` }]}>
...
const styles = StyleSheet.create({
  ...
  heroBanner: {
    ...
    backgroundColor: colors.surface1, borderWidth: 1, borderColor: colors.orangeGlow,
  },
  heroLeft: { gap: 8 },
  heroLabel: {
  ...
  modalTitle: {
    fontSize: 32, fontWeight: '900', color: colors.text, letterSpacing: -1,
  },
  modalSub: {
  ...
  pricingCardBest: {
    borderColor: colors.orange, backgroundColor: colors.orangeDim,
  },
  bestBadge: {
