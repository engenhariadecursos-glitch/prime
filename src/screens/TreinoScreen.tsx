  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <View style={styles.progressWrap}>
        ...
        <Text style={styles.progressLabel}>{completedSetsCount}/{totalSets} sets</Text>
      </View>
            ...
            >
              <View style={styles.exHeader}>
                <View style={styles.exNum}>
                  <Text style={styles.exNumTxt}>{exIdx + 1}</Text>
                </View>
              ...
              {isExpanded && (
                <View style={styles.exBody}>
                      ...
                      return (
                        ...
                        >
                          ...
                          {done && log?.weight ? (
                            ...
                            <Text style={styles.setReps}>{ex.reps} reps</Text>
                          )}
                        </TouchableOpacity>
                      );
                    })}
                  ...
                  >
                    <Text style={styles.restBtnTxt}>⏱️ Iniciar descanso ({ex.restSecs ?? 60}s)</Text>
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  splitLabel: { fontSize: 11, color: colors.orange, fontWeight: '700', letterSpacing: 1.2, textTransform: 'uppercase' },
  ...
  progressBar: { flex: 1, height: 4, backgroundColor: colors.surface3, borderRadius: 2, overflow: 'hidden' },
  progressFill: { height: '100%', backgroundColor: colors.orange, borderRadius: 2 },
  progressLabel: { fontSize: 12, color: colors.muted, fontWeight: '600', minWidth: 60 },
  ...
  exCardDone: { borderColor: colors.green, backgroundColor: 'rgba(0,229,170,0.04)' },
  ...
  exBody: { padding: 14, paddingTop: 0, gap: 12 },
  ...
  setBtnDone: { backgroundColor: colors.greenDim, borderColor: colors.green },
  ...
  finishBtnDone: { backgroundColor: colors.green },
